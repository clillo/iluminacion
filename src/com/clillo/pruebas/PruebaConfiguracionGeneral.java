...
public class PruebaConfiguracionGeneral extends JFrame implements ActionListener{

	private static final long serialVersionUID = 1823403452881818081L;
	
	public PruebaConfiguracionGeneral() {
		enableEvents(64L);
		try {
	...
	private void initialize() {
		setSize(860, 350);
		setContentPane(new PanelConfiguracion());
	}
	...
	public static void main(String[] args) {
		PruebaConfiguracionGeneral vp = new PruebaConfiguracionGeneral();
		vp.validate();
