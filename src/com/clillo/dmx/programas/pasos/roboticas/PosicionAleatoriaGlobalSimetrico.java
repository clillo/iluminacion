...
public class PosicionAleatoriaGlobalSimetrico extends PosicionPadre{
	...
	public void mueve(){
		...
		for (FixtureRobotica fixture: grupo.getListaFixtures()){
			...
			if ((n++%2)==0)
				...
				mueveEntidad(fixture.getPosicionInversaPan(pan), fixture.getPosicionInversaTilt(tilt), fixture);
		}
	}
