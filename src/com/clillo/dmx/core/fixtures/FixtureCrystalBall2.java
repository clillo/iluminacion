...
public class FixtureCrystalBall2 extends Fixture{

	private static final File ARCHIVO = new File("conf/fixtures/crystalBall2.xml");
	...
	public FixtureCrystalBall2(int id, String nombre) {
		super(id, nombre);
		try {
