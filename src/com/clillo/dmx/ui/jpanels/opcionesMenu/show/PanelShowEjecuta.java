...
public class PanelShowEjecuta extends PanelMenuGenerico implements ActionListener{
	...
	private JList<EscenaAutomatico> lstShow;
	private JList<ShowDetalle> lstDetalleShow;
	private EjecutorShow ejecutor;
	
	public PanelShowEjecuta() {
	    this.configura(460, 300, "Ejecutor Show");
	  	this.setLayout(null);
		...
		scrollPane.setBounds(22, 44, 137, 185);
		pnlRGBStageLigth.add(scrollPane);
		
		lstShow = new JList<EscenaAutomatico>();
		lstShow.setListData(ListaShow.obtieneLista());
		scrollPane.setViewportView(lstShow);
		
		JScrollPane scrollPane_1 = new JScrollPane();
		scrollPane_1.setBounds(181, 42, 207, 187);
