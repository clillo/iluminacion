...
public class PanelSubMasterPrograma extends JPanel implements NotificableEjecutorPasos, ActionListener, ChangeListener, AdjustmentListener, MouseListener{
	...
	public void refresca(){
		if (!cambiaVelocidad()){
			...
			txtProbabilidad.setText("Probabilidad: "+programa.getParametros().getProbabilidadGlobalNormalizada()+" Nro. de ejecuciones: "+programa.getParametros().getCantidadEjecuciones()+" Tiempo de ejecuciÃ³n: "+programa.getParametros().getSumaTiempos()/1000);
		}else{
			txtNombre.setText(programa.getNombre()+" ("+programa.getPorcentajeVelocidadActual()+"%)");
