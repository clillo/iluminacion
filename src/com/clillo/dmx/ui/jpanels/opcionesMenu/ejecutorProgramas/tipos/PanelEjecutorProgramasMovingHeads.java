...
public class PanelEjecutorProgramasMovingHeads extends JPanel implements InterfacePanelEjecutorProgramas{
	...
	private ConjuntoProgramas conjuntoProgramasPosiciones = new ConjuntoProgramas(TipoPrograma.MovingHeadPosicion);
	private ConjuntoProgramas conjuntoProgramasColor = new ConjuntoProgramas(TipoPrograma.MovingHeadColor);
	private ConjuntoProgramas conjuntoProgramasDimmer = new ConjuntoProgramas(TipoPrograma.MovingHeadDimmer);
	private ConjuntoProgramas conjuntoProgramasGobos = new ConjuntoProgramas(TipoPrograma.MovingHeadGobos);
	private ConjuntoProgramas conjuntoProgramasStrobo = new ConjuntoProgramas(TipoPrograma.MovingHeadStrobo);

	public PanelEjecutorProgramasMovingHeads() {
	  	setLayout(null);
