...
public class IldaReader {
    ...
    public static void main(String args[]) throws Exception {
        ...
        IldaFormat content = reader.read(new File("03.ild"));
        ...
        for (CoordinateHeader coordinateHeader : coordinateHeaders) {
            ...
            for (CoordinateData dat : data) {
                System.out.print("Frame nr: " + coordinateHeader.getFrameNumber() + ", point : " + index++  + ": x= " + dat.getX() + ", y= " + dat.getY() + ", z= " + dat.getZ() + ", color: " + dat.getColorData());
            }
        }
